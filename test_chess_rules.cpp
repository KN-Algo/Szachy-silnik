...
Move stringToMove(const std::string& moveStr) {
    ...
    // Ustawiamy movedPiece i capturedPiece na podstawie aktualnej pozycji na planszy
    // W prawdziwym teście można byłoby to zrobić lepiej, ale dla uproszczenia zakładamy, że Board jest dostępny
...
void testPromotion() {
    ...
    // Sprawdź ruch e7e8 z promocją do skoczka (bez literki promocji)
